...
## Nota para modo demo publico

Para evitar abuso en un deploy publico, conviene combinar:

- rate limit por IP/usuario en backend
- cuotas de uploads por usuario
- limpieza automatica de datos demo (TTL)
- captcha en login/registro/upload
